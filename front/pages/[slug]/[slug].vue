                ...
                <div class="promo__wrapper row align-items-center">
                    ...
                    <div class="promo__text col-lg-7 col-xl-7">
                        ...
                        <div class="promo__text">
                            Здесь можно разместить короткий поясняющий (завлекающий) текст, который расскажет об
                            эффективности
                            тренировок
                            или их преимуществах перед конкурентами
                        </div>
            ...
            <section class="page__desc">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h2>О ПРОГРАММЕ</h2>
                        <p>Таким образом укрепление и развитие структуры позволяет выполнять важные задания по разработке
                            новых
