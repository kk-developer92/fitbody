            ...
            <ul class="nav nav-tabs tab-gender pt-2 justify-content-center mb-4" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#training-woman" type="button"
                            role="tab"
                            aria-selected="false">Для женщин
                    </button>
                </li>
            </ul>
            <!-- tab1 -->
                    ...
                    <button class="btn btn-primary button w-100">
                        <svg width="51" height="50" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M38.9198 34.1667C39.1847 32.1541 38.0642 30.2146 36.1883 29.4388L36.0939 29.3997C34.9937 28.9447 34.1198 28.0707 33.6647 26.9706L33.6254 26.8756C32.8497 25 30.9106 23.8798 28.8983 24.1445L28.7892 24.1589C27.6072 24.3144 26.4119 23.9939 25.4663 23.2679L25.3913 23.2102C23.7816 21.9744 21.5423 21.9744 19.9327 23.2102L19.8478 23.2754C18.9053 23.999 17.7139 24.3185 16.5358 24.1635L16.4233 24.1487C14.4108 23.8838 12.4716 25.005 11.697 26.8813L11.6592 26.9727C11.2044 28.0742 10.3295 28.9492 9.22795 29.4039L9.13654 29.4417C7.26026 30.2163 6.13907 32.1555 6.40387 34.168"
                                  stroke="currentColor" stroke-width="3" stroke-linecap="round"
                                  stroke-linejoin="round"/>
                            <path d="M13.2073 24.9584L4.83225 16.5834C4.0404 15.795 3.73008 14.6436 4.01849 13.5641C4.30691 12.4846 5.1501 11.6414 6.22964 11.353C7.30917 11.0646 8.46054 11.3749 9.24892 12.1667L20.1448 23.0626"
                                  stroke="currentColor" stroke-width="3" stroke-linecap="round"
                                  stroke-linejoin="round"/>
